...
import { phoneDisplay, waHref } from "@/lib/contact";
      ...
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <Reveal>
            ...
            <a
              href={`tel:${tel}`}
              className="mt-9 flex items-center gap-3 rounded-2xl bg-lime px-6 py-4 text-charcoal transition-transform hover:-translate-y-0.5"
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.9.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z" />
              </svg>
              <span className="nums font-display text-lg font-extrabold tracking-wide">
                {phoneDisplay()}
              </span>
            </a>
            ...
            <a
              ...
              className="mt-3 flex items-center gap-3 rounded-2xl bg-[#25D366] px-6 py-4 text-lg font-semibold text-white transition-transform hover:-translate-y-0.5"
            >
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              ...
              >
                ...
                <span className="mt-1 block text-base text-white/80">{t.contact.fbLabel}</span>
              </a>
            ...
            <div className="mt-4 rounded-2xl border border-white/15 px-5 py-4">
              ...
              <span className="mt-1 block text-base text-white/80">{site.location}</span>
            </div>
          </Reveal>
