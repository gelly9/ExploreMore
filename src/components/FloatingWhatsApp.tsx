...
// Persistent click-to-chat button, bottom-right on every page.
export function FloatingWhatsApp({ t }: { t: Content }) {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg ring-1 ring-black/10 transition-transform hover:scale-105 active:scale-95"
    >
