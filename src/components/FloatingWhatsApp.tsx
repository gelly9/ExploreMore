    ...
    <div className="fixed bottom-5 right-5 z-40">
      ...
      <div className="flex flex-col items-end gap-3">
        ...
        <a
          ...
          className={`flex h-12 w-12 items-center justify-center rounded-full bg-lime text-charcoal shadow-lg ring-1 ring-black/10 transition-all duration-300 ease-out hover:scale-105 active:scale-95 ${
            open
        ...
        <a
          ...
          className={`flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg ring-1 ring-black/10 transition-all duration-300 ease-out hover:scale-105 active:scale-95 ${
            open
              ? "translate-y-0 scale-100 opacity-100"
              : "pointer-events-none translate-y-3 scale-90 opacity-0"
          }`}
